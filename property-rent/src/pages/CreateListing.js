  ...
  const onSubmit = async (e) => {
    ...
    if (geoLoactionEnable) {
      const response = await fetch(
        `https://maps.googleapis.com/maps/api/geocode/json?address=${address}&key=AIzaSyDyJnZMI-l_G5Sh9L0-EC5xLAHE9bXXLDE`
      );
          ...
          <div className="mb-3 mt-4">
            ...
            <div className=" d-flex flex-row ">
              <input
                ...
                required
              />
              {type === "bachelor" && <p className="ms-4 mt-2">$ / Month</p>}
            </div>
          </div>
