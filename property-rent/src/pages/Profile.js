...
// import { db2 } from "../firebase2.config";
...
const Profile = () => {
  ...
  return (
    <Layout>
      ...
      <div className="container mt-4 w-50 d-flex justify-content-between">
        <button className="btn btn-primary" onClick={() => navigate("/create-listing/bachelor")}>Create Bachelor Rent</button>
        <button className="btn btn-primary" onClick={() => navigate("/create-listing/family")}>Create Family Rent</button>
      </div>
